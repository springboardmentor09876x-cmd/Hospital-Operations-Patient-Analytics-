...
def generate_pdf():
    ...
    with PdfPages(OUTPUT_PDF) as pdf:
        ...
        add_panel(ax, 0.03, 0.45, 0.32, 0.27, "Monthly Admissions Trend")
        ax_viz1 = fig.add_axes([0.05, 0.47, 0.28, 0.21])
        ...
        add_panel(ax, 0.38, 0.45, 0.33, 0.27, "Admissions by Department")
        ax_viz2 = fig.add_axes([0.40, 0.47, 0.29, 0.21])
        ...
        add_panel(ax, 0.03, 0.12, 0.32, 0.29, "Admission Type Distribution")
        ax_viz3 = fig.add_axes([0.05, 0.13, 0.28, 0.24])
        ...
        add_panel(ax, 0.38, 0.12, 0.33, 0.29, "Readmission by Hospital")
        ax_viz4 = fig.add_axes([0.43, 0.14, 0.26, 0.23])
        ...
        add_panel(ax, 0.03, 0.40, 0.32, 0.32, "Length of Stay Categories")
        ax_viz2_1 = fig.add_axes([0.05, 0.42, 0.28, 0.27])
        ...
        add_panel(ax, 0.38, 0.40, 0.33, 0.32, "Daily Inflow vs Outflow Trends")
        ax_viz2_2 = fig.add_axes([0.40, 0.43, 0.29, 0.26])
        ...
        add_panel(ax, 0.03, 0.03, 0.32, 0.33, "Peak Admissions by Hour of Day")
        ax_viz2_3 = fig.add_axes([0.06, 0.06, 0.26, 0.26])
        hours = np.arange(24)
        ...
        add_panel(ax, 0.38, 0.03, 0.33, 0.33, "Department Transfer Frequency")
        ax_viz2_4 = fig.add_axes([0.41, 0.06, 0.28, 0.26])
        ...
        add_panel(ax, 0.03, 0.40, 0.32, 0.32, "Department Efficiency Rankings")
        ax_viz3_1 = fig.add_axes([0.05, 0.43, 0.28, 0.26])
        ...
        add_panel(ax, 0.38, 0.40, 0.33, 0.32, "Billing vs. Average Length of Stay")
        ax_viz3_2 = fig.add_axes([0.41, 0.43, 0.28, 0.26])
        ...
        add_panel(ax, 0.03, 0.03, 0.32, 0.33, "Treatment Capacity Index")
        ax_viz3_3 = fig.add_axes([0.06, 0.06, 0.26, 0.26])
        ...
        add_panel(ax, 0.38, 0.03, 0.33, 0.33, "Top Diagnoses volume")
        ax_viz3_4 = fig.add_axes([0.40, 0.06, 0.29, 0.26])
        ...
        add_panel(ax, 0.03, 0.40, 0.32, 0.32, "Bed Occupancy Forecast")
        ax_viz4_1 = fig.add_axes([0.05, 0.43, 0.28, 0.26])
        ...
        add_panel(ax, 0.38, 0.40, 0.33, 0.32, "Staff to Patient Ratios")
        ax_viz4_2 = fig.add_axes([0.41, 0.43, 0.28, 0.26])
        ...
        add_panel(ax, 0.03, 0.03, 0.32, 0.33, "Equipment Usage Tracker")
        ax_viz4_3 = fig.add_axes([0.08, 0.06, 0.24, 0.26])
        ...
        add_panel(ax, 0.38, 0.03, 0.33, 0.33, "Staff Workload Distribution")
        ax_viz4_4 = fig.add_axes([0.41, 0.06, 0.28, 0.26])

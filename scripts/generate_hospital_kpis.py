...
INPUT_FILE = os.path.join(SCRIPT_DIR, "..", "data", "hospital_cleaned.csv")
OUTPUT_EXCEL = os.path.join(SCRIPT_DIR, "..", "data", "hospital_final_dataset.xlsx")
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "..", "data", "hospital_final_dataset.csv")
